...
Click **"Load Sample Data"** on the Home page to explore the dashboard with 20 pre-loaded papers and citation network — no API calls needed.

### 5. Full Pipeline

Enter a research topic (e.g., *"Graph Neural Networks"*) and click **"Run Full Analysis Pipeline"** to:
